...
function ImageWithCamaraButtom({ image_uri }: Props) {
  const { navigationToPath } = useNavigate();
  return (
    <View style={styleImageWithCamaraButtom.imageContainer}>
      <Image
        source={{
          uri:
            image_uri !== ""
              ? image_uri
              : "https://lh3.googleusercontent.com/aida-public/AB6AXuApE1Q3wx8AiTmo88PQGdUA6nGozBIk7qZcOJXzR_zZIMHto4Kaoqe4MTTsLLfo0T0iFuXkRwbzqMy7Qxo8_QKLPyQVKNUcb39nYJSiALDaadTKSiI1TTigwZjV8-oGv2rTlhJX8s_MBnB4Sd8zWmgx1ro8i_4ZPJJfNd1FIWJvi0PyvO09Pt72v8PYkNSN_NHQ6mJQYU7qXH3lPXwxMVacNvwe3vbYv2mHaB8363yGs6R6n20Ds02FsJn-O4ojIo49EZaZO3C9eUw",
        }}
      ...
      <TouchableOpacity
        onPress={() => {
          navigationToPath("CameraScreen");
        }}
        style={styleImageWithCamaraButtom.cameraButton}
      >
